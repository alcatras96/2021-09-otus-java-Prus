...
public class ATMImplTest {
    ...
    void shouldGiveTheRequestedAmountWithTheMinimumNumberOfBanknotes() {
        List<Banknote> banknotes = atm.withdraw(1510);

        assertThat(banknotes).isEqualTo(Arrays.asList(Banknote.from(THOUSAND), Banknote.from(FIVE_HUNDRED), Banknote.from(TEN)));
    }
